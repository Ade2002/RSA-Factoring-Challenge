...
chmod u+x factors.c && git add --chmod=+x factors.c && git commit -m 'Advanced Task 10 tCreate three C functions that print some basic info about Python lists, Python bytes an Python float objects. factors.c' && git push
